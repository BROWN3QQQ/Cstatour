...
public class Entertainment {
    ...
    public Entertainment(String id, String name, String imgadres, String motherspot, String spendtime, String moneystr, BigDecimal money, String moneyintroduce, String timeinterval, String level, int index, boolean hot, boolean useful, String introduce, String remarks) {
        this.id = id;
        this.name = name;
    ...
    public Entertainment(String name, String imgadres, String motherspot, String spendtime, String moneystr, BigDecimal money, String moneyintroduce, String timeinterval, String level, int index, boolean hot, boolean useful, String introduce, String remarks) {
        this.name = name;
        this.imgadres = imgadres;
        this.motherspot = motherspot;
        this.spendtime = spendtime;
